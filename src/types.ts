...
export type AppId = 'terminal' | 'settings' | 'notepad' | 'browser' | 'photos' | 'music' | 'appfolder' | 'codestudio' | 'files' | 'systemmonitor' | 'glassword' | 'spreadsheet' | 'glassmail' | 'glassdatabase' | 'glassmessaging' | 'printers' | 'calendar' | 'taskscheduler' | 'glassdraw' | 'glasspaint' | 'glassphoto' | 'videostudio' | 'lanbridge' | string;
